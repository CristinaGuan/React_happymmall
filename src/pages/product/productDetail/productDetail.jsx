	                  ...
	                  <div className="form-horizontal">
						  <div className="form-group">
						    ...
						    <div className="col-md-5">
						     <p className="form-control-static" readOnly>{this.state.name}</p>
						    </div>
						  </div>
						  <div className="form-group">
						    <label className="col-md-2 control-label">商品描述</label>
						    <div className="col-md-5">
						      <p className="form-control-static" readOnly>{this.state.subtitle}</p>
						    </div>
						  </div>
						  <div className="form-group">
						    <label className="col-md-2 control-label">所属分类</label>
						    	<ProductCategorySelector readOnly categoryId={this.state.categoryId}
